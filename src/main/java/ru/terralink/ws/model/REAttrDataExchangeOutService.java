 ...
 * 
 */
@WebServiceClient(name = "REAttrDataExchangeOutService", targetNamespace = "http://inform.gazprom.ru/C/SUIM/REDataExchange") //wsdlLocation = "file:/D:/Workspace/JavaProjects/MSUIM/REAttrDataExch.wsdl"
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new ClassPathResource("REAttrDataExch.wsdl").getURL();
